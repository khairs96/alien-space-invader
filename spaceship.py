...
from settings import SPACESHIP_IMAGE_PATH, SCREEN_WIDTH, SCREEN_HEIGHT, OFFSET, SPACESHIP_LASER_SPEED, LASER_SOUND_PATH
...
class Spaceship(pygame.sprite.Sprite):
	...
	def get_user_input(self):
		...
		if keys[pygame.K_SPACE] and self.laser_ready:
			...
			laser = Laser(self.rect.center, SPACESHIP_LASER_SPEED, self.screen_height)
